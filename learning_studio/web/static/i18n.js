...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      "card.order_hint_drag": "Drag the items into order, or use the up and down buttons.",
      "card.timeline_hint": "Put these in order, earliest first.",
      "card.timeline_hint_drag": "Drag the events into order, earliest first, or use the up and down buttons.",
      ...
      "card.drag_handle": "Drag to reorder",
      "card.undo_move": "Undo move",
      "card.moved": "Moved from position {from} to {to} of {count}.",
      "card.move_cancelled": "Move cancelled.",
      "card.position_unchanged": "Still at position {position} of {count}.",
      "card.move_undone": "Move undone.",
    ...
    fr: {
      ...
      "card.order_hint_drag": "Faites glisser les éléments dans l'ordre, ou utilisez les boutons haut et bas.",
      "card.timeline_hint": "Mettez ceci en ordre, du plus ancien au plus récent.",
      "card.timeline_hint_drag": "Faites glisser les événements dans l'ordre, du plus ancien au plus récent, ou utilisez les boutons haut et bas.",
      ...
      "card.move_up": "Monter",
      "card.drag_handle": "Faire glisser pour réordonner",
      "card.undo_move": "Annuler le déplacement",
      "card.moved": "Déplacement de la position {from} à {to} sur {count}.",
      "card.move_cancelled": "Déplacement annulé.",
      "card.position_unchanged": "Toujours à la position {position} sur {count}.",
      "card.move_undone": "Dernier déplacement annulé.",
    ...
    es: {
      ...
      "card.order_hint_drag": "Arrastra los elementos para ordenarlos o usa los botones de subir y bajar.",
      "card.timeline_hint": "Ordénalas, de lo más antiguo a lo más reciente.",
      "card.timeline_hint_drag": "Arrastra los eventos para ordenarlos, del más antiguo al más reciente, o usa los botones de subir y bajar.",
      ...
      "card.move_up": "Subir",
      "card.drag_handle": "Arrastrar para reordenar",
      "card.undo_move": "Deshacer movimiento",
      "card.moved": "Se ha movido de la posición {from} a la {to} de {count}.",
      "card.move_cancelled": "Movimiento cancelado.",
      "card.position_unchanged": "Sigue en la posición {position} de {count}.",
      "card.move_undone": "Último movimiento deshecho.",
