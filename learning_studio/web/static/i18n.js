...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      "card.hotspot_keyboard": "Or use the arrow keys once the image has focus.",
    ...
    fr: {
      ...
      "card.hotspot_keyboard": "Ou utilisez les flèches lorsque l'image a le focus.",
    ...
    es: {
      ...
      "card.hotspot_keyboard": "O usa las flechas cuando la imagen tenga el foco.",
